									...
									<div class="vert-center">
									    ...
									    if( !empty($video_embed) || !empty($video_m4v) ) {
										    ...
										    if( !empty( $video_embed) && floatval(get_bloginfo('version')) < "3.6") {
										    	...
										    	echo '<a href="#video-popup-'.$post->ID.'"  class="pretty_photodefault-link ">'.__("Watch Video", NECTAR_THEME_NAME).'</a> ';
												...
												echo '</div>';
												 ...
												 echo '<a class="default-link" href="'.get_template_directory_uri(). '/includes/portfolio-functions/video.php?post-id=' .$post->ID.'&iframe=true&width=854" class="pretty_photo default-link" >'.__("Watch Video", NECTAR_THEME_NAME).'</a> ';	 
										     }
