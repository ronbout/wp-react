		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col span_9 col_last">
					...
					<?php if($has_main_menu == 'true' && $mobile_fixed == 'false') echo '<a href="#mobilemenu" id="toggle-nav"><i class="icon-reorder"></i></a>'; ?>
