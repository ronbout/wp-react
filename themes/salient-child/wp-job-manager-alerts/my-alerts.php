 ...
 *
 *	This is an override of the WP Job Manager My Alert Template
 *
 *	Ron Boutilier
 *	01/05/2018
 */
...
<div id="job-manager-alerts">
	<!-- testcache
		<?php echo time();  ?>
	    -->
	<p><?php printf( __( 'Your job alerts are shown in the table below and will be emailed to %s.', 'wp-job-manager-alerts' ), $user->user_email ); 
					 printf( __( '<br>Due to browser caching, you may need to refresh the page to see the latest changes.', 'wp-job-manager-alerts' ) ); ?></p>
