 ...
 *
 *	This is an override of the WP Job Manager resumes dashboard template
 *	Ron Boutilier
 *	01/05/2018
 */
...
<div id="resume-manager-candidate-dashboard">
	<p><?php echo _n( 'Your resume can be viewed, edited or removed below.', 'Your resume(s) can be viewed, edited or removed below.', resume_manager_count_user_resumes(), 'wp-job-manager-resumes' ); 
					 printf( __( '<br>Due to browser caching, you may need to refresh the page to see the latest changes.', 'wp-job-manager-resumes' ) );?></p>
